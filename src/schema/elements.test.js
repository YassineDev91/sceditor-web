...
describe('createGuard', () => {
  it('creates a guard with defaults', () => {
    ...
    expect(g.body).toEqual({ steps: [], edges: [], startStepId: null })
...
describe('createFunction', () => {
  it('creates a function with defaults', () => {
    ...
    expect(f.body).toEqual({ steps: [], edges: [], startStepId: null })
...
describe('createConstructor', () => {
  it('creates a constructor with defaults', () => {
    ...
    expect(c.body).toEqual({ steps: [], edges: [], startStepId: null })
